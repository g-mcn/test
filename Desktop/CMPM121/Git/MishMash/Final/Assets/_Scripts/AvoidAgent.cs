...
public class AvoidAgent : enemyBehaviour
{
    ...
    public override Steering GetSteering()
    {
        ...
        {
            Vector3 relativePos;
            Enemy targetEnemy = t.GetComponent<Enemy>();
            relativePos = t.transform.position - transform.position;
            Vector3 relativeVel = targetEnemy.velocity - foe.velocity;
        ...
        steering.linear = -firstRelativePos * foe.maxAccel;
        return steering;
